        ...
        try{
            if(event.getSource().getClass() == MenuItem.class){
                ...
                if(item.getText() == MainWindow.NEW_DATABASE_TXT){
                    syncWithRemoteDatabaseMenuItem.setText(NEW_DATABASE_TXT);
                    dbActions.newDatabase();
                } else if(item.getText() == MainWindow.OPEN_DATABASE_TXT){
                    syncWithRemoteDatabaseMenuItem.setText(OPEN_DATABASE_TXT);
                    dbActions.openDatabase();
                } else if(item.getText() == MainWindow.OPEN_DATABASE_FROM_URL_TXT){
                    syncWithRemoteDatabaseMenuItem.setText(OPEN_DATABASE_FROM_URL_TXT);
